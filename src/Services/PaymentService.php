...
public function allowedCountries(Basket $basket, $allowedCountry): bool
{
    ...
    public function getPaymentData(&$paymentRequestData, $paymentKey)
    {
        ...
        if(in_array($paymentKey, ['NOVALNET_SEPA', 'NOVALNET_CC', 'NOVALNET_INVOICE', 'NOVALNET_APPLEPAY', 'NOVALNET_GUARANTEED_INVOICE',
         'NOVALNET_GUARANTEED_SEPA', 'NOVALNET_INSTALMENT_SEPA', 'NOVALNET_INSTALMENT_INVOICE', 'NOVALNET_PAYPAL', 'NOVALNET_GOOGLEPAY']) 
         && !empty($this->settingsService->getPaymentSettingsValue('payment_action', strtolower($paymentKey)))) {
